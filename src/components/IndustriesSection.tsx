...
const industries = [
  {
    ...
    desc: "Shift transport, plant access",
  ...
  {
    name: "Mining & metals",
    desc: "Remote sites, crew transport",
  ...
  {
    name: "Government & PSU",
    desc: "Official transport, state ops",
  ...
  {
    name: "IT & technology",
    desc: "Campus, shift-based, executive",
  ...
  {
    name: "Healthcare",
    desc: "Staff mobility, patient transport",
  ...
  },
  {
    ...
    desc: "Guest transport, airport pickups",
  ...
  },
  {
    ...
    desc: "Project sites, power plants",
